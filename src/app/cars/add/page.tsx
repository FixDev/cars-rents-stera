...
export default function AddCar() {
  ...
  return (
    <form className="p-20" onSubmit={addSubmit}>
      <h1 className="text-2xl font-bold mb-6">Tambah Mobil</h1>

      {showAlert && (
        <div className="flex items-center gap-3 bg-green-100 border border-green-300 text-green-800 px-4 py-2 rounded mb-4">
          <CheckCircle className="h-5 w-5" />
          <span className="font-semibold">Berhasil menambahkan mobil</span>
        </div>
      )}
